...
<head>
	...
	<title>PiggyPennies</title>
	<meta name="description" content="PiggyPennies helps you save money with your friends to do what you want." />
	<meta name="keywords" content="piggypennies" />
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white">PiggyPennies helps you</h3>
							<h1 class="white typed">spend your loose change with friends.</h1>
	...
	<footer>
		<div class="container">
			<div class="row bottom-footer text-center-mobile">
				<div class="col-sm-8">
					<p>&copy; 2016 All Rights Reserved. Powered by <a href="http://www.capitalone.com/">Capital One</a>.</p>
				</div>
				<div class="col-sm-4 text-right text-center-mobile">
					<ul class="social-footer">
						<li><a href="http://www.facebook.com/speakerbug"><i class="fa fa-facebook"></i></a></li>
						<li><a href="http://www.twitter.com/speakerbug"><i class="fa fa-twitter"></i></a></li>
